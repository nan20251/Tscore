...
import tscore
from tscore.models import DeepDock_PPI, ppi_train_loss, ppi_score_diff
from tscore.utils.data import PPI_Dataset, ppi_collate
...
def main():
    parser = argparse.ArgumentParser(description='Tscore 训练脚本')
    ...
    print(f"Tscore v{tscore.__version__}")
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if epoch % args.save_every == 0:
            torch.save({
                ...
                'optimizer_state_dict': optimizer.state_dict(),
                'loss': test_loss,
            }, os.path.join(args.save_dir, f'Tscore_epoch_{epoch:03d}.chk'))
